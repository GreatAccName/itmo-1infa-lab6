...
\begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}    \hline
        Фигура &
        \begin{sideways} Ко\-роль \end{sideways} &
        \begin{sideways} Ферзь \end{sideways} &
        \begin{sideways} Ладья \end{sideways} &
        \begin{sideways} Слон \end{sideways} &
        \begin{sideways} Конь \end{sideways} &
        \begin{sideways} Пеш\-шка \end{sideways} \\ \hline
        Число & & & & & & \\
        внешней & 9 & 5 & 8 & 8 & 12 & 32 \\  
        устойчивости & & & & & & \\ \hline
        Число & & & & & & \\
        внутренней & 16 & 8 & 8 & 14 & 32 & 32 \\
        устойчивости & & & & & & \\ \hline
    \end{tabular}
